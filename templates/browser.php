...
?>
<div class="dfxtgfeed-browser dfxtgfeed-layout<?php echo !empty($wrapper_class) ? ' ' . esc_attr($wrapper_class) : ''; ?>"><?php foreach ($messages as $msg): ?>
        <?php
        ...
        ?>
        <article class="dfxtgfeed-message dfxtgfeed-message-browser <?php echo $is_sticker ? 'dfxtgfeed-sticker' : ''; ?>" data-id="<?php echo esc_attr($msg['id']); ?>">
            <!-- 1. Date (first) -->
            ...
            <?php if (!empty($msg['media']) && !empty($msg['file_id'])): ?>
                ...
                <div class="dfxtgfeed-media dfxtgfeed-media-browser <?php echo $is_sticker ? 'dfxtgfeed-media-sticker' : ''; ?>">
                    <?php
                    ...
                    ?>
                        <div class="dfxtgfeed-sticker-container dfxtgfeed-sticker-browser" data-file-id="<?php echo esc_attr($msg['file_id']); ?>"></div>
                        <?php if ($has_emoji): ?>
                    ...
                    <?php elseif ($is_sticker && $sticker_type === 'webm'):
                        // WEBM video sticker
                    ?>
                        <video class="dfxtgfeed-sticker-video dfxtgfeed-sticker-browser" autoplay loop muted playsinline>
