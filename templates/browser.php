...
?>
<div class="dfxfftc-browser dfxfftc-layout<?php echo !empty($wrapper_class) ? ' ' . esc_attr($wrapper_class) : ''; ?>"><?php foreach ($messages as $msg): ?>
        <?php
        ...
        ?>
        <article class="dfxfftc-message dfxfftc-message-browser <?php echo $is_sticker ? 'dfxfftc-sticker' : ''; ?>" data-id="<?php echo esc_attr($msg['id']); ?>">
            <!-- 1. Date (first) -->
            ...
            <?php if (!empty($msg['media']) && !empty($msg['file_id'])): ?>
                ...
                <div class="dfxfftc-media dfxfftc-media-browser <?php echo $is_sticker ? 'dfxfftc-media-sticker' : ''; ?>">
                    <?php
                    ...
                    ?>
                        <div class="dfxfftc-sticker-container dfxfftc-sticker-browser" data-file-id="<?php echo esc_attr($msg['file_id']); ?>"></div>
                        <?php if ($has_emoji): ?>
                    ...
                    <?php elseif ($is_sticker && $sticker_type === 'webm'):
                        // WEBM video sticker
                    ?>
                        <video class="dfxfftc-sticker-video dfxfftc-sticker-browser" autoplay loop muted playsinline>
