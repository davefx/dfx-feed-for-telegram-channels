...
import { PanelBody, TextControl, RangeControl, TabPanel, SelectControl, __experimentalUnitControl as UnitControl, __experimentalBoxControl as BoxControl } from '@wordpress/components';
                    ...
                    >
                        {(tab) => {
                            if (tab.name === 'settings') {
                                return (
                                    <>
                                        <PanelBody title={__('General Settings', 'dfx-tg-feed')} initialOpen={true}>
                                            <TextControl
                                ...
                                return (
                                    <>
                                        <PanelBody title={__('Block Container', 'dfx-tg-feed')} initialOpen={true}>
                                            <TextControl
                                                label={__('Background Color', 'dfx-tg-feed')}
                                                help={__('e.g., #ffffff or transparent', 'dfx-tg-feed')}
                                                value={attributes.blockBackground}
                                                onChange={(value) => setAttributes({ blockBackground: value })}
                                            />
                                            <SelectControl
                                                label={__('Border Style', 'dfx-tg-feed')}
                                            ...
                                            {attributes.blockBorderStyle && (
                                                <>
                                                    <UnitControl
                                                        label={__('Border Width', 'dfx-tg-feed')}
                                                        value={attributes.blockBorderWidth}
                                                        onChange={(value) => setAttributes({ blockBorderWidth: value })}
                                                    />
                                                    <TextControl
                                                        label={__('Border Color', 'dfx-tg-feed')}
                                                        help={__('e.g., #e1e8ed', 'dfx-tg-feed')}
                                ...
                                return (
                                    <>
                                        <PanelBody title={__('Message Container', 'dfx-tg-feed')} initialOpen={true}>
                                            <TextControl
                                                label={__('Background Color', 'dfx-tg-feed')}
                                                help={__('e.g., #ffffff', 'dfx-tg-feed')}
                                                value={attributes.messageBackground}
                                                onChange={(value) => setAttributes({ messageBackground: value })}
                                            />
                                            <SelectControl
                                                label={__('Border Style', 'dfx-tg-feed')}
                                                value={attributes.messageBorderStyle}
                                                options={borderStyles}
                                                onChange={(value) => setAttributes({ messageBorderStyle: value })}
                                            />
                                            {attributes.messageBorderStyle && (
                                                <>
                                                    <UnitControl
                                                        label={__('Border Width', 'dfx-tg-feed')}
                                                        value={attributes.messageBorderWidth}
                                                        onChange={(value) => setAttributes({ messageBorderWidth: value })}
                                                    />
                                                    <TextControl
                                                        label={__('Border Color', 'dfx-tg-feed')}
                                                        help={__('e.g., #e1e8ed', 'dfx-tg-feed')}
                                                        value={attributes.messageBorderColor}
                                                        onChange={(value) => setAttributes({ messageBorderColor: value })}
                                                    />
                                                    <UnitControl
                                                        label={__('Border Radius', 'dfx-tg-feed')}
                                                        value={attributes.messageBorderRadius}
                                            ...
                                            {BoxControl && (
                                                <>
                                                    <BoxControl
                                                        label={__('Padding', 'dfx-tg-feed')}
                                                        values={attributes.messagePadding}
                                                        onChange={(value) => setAttributes({ messagePadding: value })}
                                                    />
                                                    <BoxControl
                                                        label={__('Margin', 'dfx-tg-feed')}
                                                        values={attributes.messageMargin}
                                                        onChange={(value) => setAttributes({ messageMargin: value })}
                                                    />
                                                </>
                                            )}
                                        </PanelBody>
                                        <PanelBody title={__('Typography', 'dfx-tg-feed')} initialOpen={false}>
                                            <h3>{__('Date', 'dfx-tg-feed')}</h3>
                                            <SelectControl
                                                label={__('Font Family', 'dfx-tg-feed')}
                                                value={attributes.dateFontFamily}
                                                options={fontFamilies}
                                                onChange={(value) => setAttributes({ dateFontFamily: value })}
                                            />
                                            <UnitControl
                                                label={__('Font Size', 'dfx-tg-feed')}
                                                value={attributes.dateFontSize}
                                                onChange={(value) => setAttributes({ dateFontSize: value })}
                                            />
                                            <hr />
                                            <h3>{__('Author', 'dfx-tg-feed')}</h3>
                                            <SelectControl
                                                label={__('Font Family', 'dfx-tg-feed')}
                                                value={attributes.authorFontFamily}
                                                options={fontFamilies}
                                                onChange={(value) => setAttributes({ authorFontFamily: value })}
                                            />
                                            <UnitControl
                                                label={__('Font Size', 'dfx-tg-feed')}
                                            ...
                                            />
                                            <hr />
                                            <h3>{__('Message Text', 'dfx-tg-feed')}</h3>
                                            <SelectControl
                                                label={__('Font Family', 'dfx-tg-feed')}
